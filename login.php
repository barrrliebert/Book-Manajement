            ...
            <div class="py-8 lg:py-12 bg-gray-100 lg:bg-white flex flex-col lg:flex-row lg:justify-between lg:px-12">
                <div class="cursor-pointer flex items-center justify-center lg:justify-start lg:ml-20 mr-[-15px] lg:mt-10">
                    <div class="flex items-center justify-between">
                        <h1 class="font-bold text-4xl lg:text-6xl text-gray-900 lg:ml-20">LOGIN</h1>
            ...
            <div class="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
                <div class="mt-12">
                    <form>
                        ...
                        <div class="mt-8">
                            <div class="flex justify-between items-center">
                                ...
                                <div>
                                    <a class="text-xs font-display font-semibold text-gray-600 hover:text-gray-800
                                    cursor-pointer">
                                        Forgot Password?
                                    </a>
                                </div>
                    ...
                    <div class="mt-12 text-sm font-display text-gray-500 text-center mb-20">
                        Don't have an account ? <a class="cursor-pointer text-gray-600 hover:text-gray-800" onclick="redirectToRegister()">Register here</a>
                    </div>
                </div>
            </div>
